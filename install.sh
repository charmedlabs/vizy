...
# Note, we can install specific versions of packages, but these packages will install the dependencies and the 
# dependencies' versions may change when new versions come out and introduce errors.  This happened with tflite and protobuf.
