...
if __name__ == "__main__":
    ...
    record_stop = kritter.Kbutton(name="Record", spinner=True)
    ...
    def func():
        print("record")
        kapp.push_mods(record_stop.out_spinner_disp(True))
        camera.duration = 3000000
    ...
    controls = html.Div([record_stop, hist_enable, mode, brightness, framerate, autoshutter,shutter_cont, awb, awb_gains, ir_filter])
